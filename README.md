...
最新一键脚本：
```
wget -N --no-check-certificate https://cdn.jsdelivr.net/gh/hbsion/CFwarp/CFwarp.sh && chmod +x CFwarp.sh && ./CFwarp.sh
```
...
- [刷新脚本](https://purge.jsdelivr.net/gh/hbsion/CFwarp/CFwarp.sh)
